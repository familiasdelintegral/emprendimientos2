...
const CONSOLIDATED_ENTRIES = [
  ...
  },
  {
    ...
    nombre: 'Carla Pandolfi',
    sala: 'Naranja',
    rubro: '✨ Otros',
    descripcion: 'Ambientamos pijamadas con carpas típis para los más chicos',
    whatsapp: '5491161524390',
  ...
  },
  {
    ...
    sala: 'Sala 4 A',
    rubro: '🩺 Salud y bienestar',
    descripcion: 'Soy psicóloga (UBA) especialista en vínculos tempranos y orientación a padres. Atiendo también adultos y adolescentes de forma presencial en Villa del Parque y online.',
    whatsapp: '5491159899007',
    instagram: 'mariapaulagerardi',
    webs: ['https://mariapaulagerardi.com.ar'],
  ...
  {
    negocio: 'Médica',
    nombre: 'Maria Clara Silva',
    sala: 'Sala 5 A',
    rubro: '💼 Profesionales',
    descripcion: 'Soy médica, en radioterapia oncológica.',
    whatsapp: '5491123142143',
    instagram: null,
    webs: [],
    fotos: [],
  },
  {
    negocio: 'Luz que Late',
    nombre: 'María Belén Paravagna',
    sala: 'Sala 3 B, Dorado',
    rubro: '🎨 Arte y creatividad',
    descripcion: 'Creo velas artesanales de cera de soja, hechas a mano, cuidando cada detalle para transformar espacios y crear momentos de calma, disfrute y conexión.\nTambién realizo pedidos personalizados para regalos, cumpleaños, souvenirs y ocasiones especiales.',
    whatsapp: '5491168698648',
    instagram: 'luzquelate.velas',
    webs: [],
    fotos: ['images/luz-que-late-maria-belen-paravagna.jpg'],
  },
  {
    negocio: 'Educación especial y acompañamiento terapéutico',
    nombre: 'Estela Di Piano',
    sala: 'Violeta',
    rubro: '📚 Educación y clases',
    descripcion: 'Educación, acompañante terapéutico, cuidado de ninxs.',
    whatsapp: '5491565225355',
    instagram: 'dipiano_relatos',
    webs: [],
    fotos: [],
  },
  {
    negocio: 'Óptica Vélez Sársfield',
    nombre: 'Natalia Gabriela Farynyk',
    sala: 'Sala 3 A, Sala 5 A',
    rubro: '🩺 Salud y bienestar',
    descripcion: 'Hace mas de 20 años que trabajo como óptica contactóloga, recibida en la universidad de Morón. Atiendo a niños, adolescentes y adultos. Lentes recetados, lentes de sol y lentes de contacto. Nuestra óptica se encuentra en la calle Bermúdez 1839, entre Alcaraz y Álvarez Jonte, en el barrio de Monte Castro.',
  ...
  },
  {
    ...
    nombre: 'Julieta De Biase',
    sala: 'Sala 2 A, Violeta',
    rubro: '💼 Profesionales',
    descripcion: 'Soy asesora integral de la Compañía Life Seguros. Me dedico específicamente a asesoramiento en planes personales (seguros de capitalización y ahorro, seguros de retiro y de protección). Son planes para el largo plazo con resguardo económico.',
    whatsapp: '5491130369250',
    instagram: 'julidan2017',
    webs: [],
    fotos: [],
  },
  {
    negocio: 'ALARMAS MARSHALL',
    nombre: 'Alejandro Luna',
    sala: 'Sala 3 A, Verde',
    rubro: '🔨 Servicios del hogar',
    descripcion: 'Empresa líder en seguridad electrónica, especializada en sistemas de alarmas y soluciones de automonitoreo para hogares y comercios.\nEstamos ubicados en Villa del Parque, además contamos con asesoramiento y venta on line.',
    whatsapp: '5491134526277',
    instagram: 'alarmas.marshall',
